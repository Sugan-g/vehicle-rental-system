...
if (loading) {
return ( <div className="flex justify-center items-center min-h-screen"> <p className="text-lg font-medium text-gray-600">Loading vehicles...</p> </div>
);
}

return ( <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-8 mt-15">
