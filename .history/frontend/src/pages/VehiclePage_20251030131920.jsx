  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6 pt-24">
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        {/* Vehicle image */}
        {vehicle.image ? (
         <img src={vehicle.image} alt={vehicle.make} className="w-full rounded-md" />

        ) : (
          <div className="w-full h-64 bg-gray-200 flex items-center justify-center rounded-lg mb-4 text-gray-500">
            No Image Available
          </div>
        )}
