...
export default function BookingPage() {
    ...
    const fetchData = async () => {
        ...
        // ✅ Fetch only the user's reviews and map them by booking ID (not vehicle)
        const reviewRes = await API.get("/reviews/my");
        const mapped = {};
        reviewRes.data.forEach(r => {
            mapped[r.booking] = { rating: r.rating, comment: r.comment };
        });
        setReviews(mapped);
    };
