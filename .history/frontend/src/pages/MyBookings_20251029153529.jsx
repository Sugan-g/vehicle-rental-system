...
export default function MyBookings() {
    ...
    return (
        <div className="px-4 pt-24 pb-6 max-w-2xl mx-auto md:pt-28">
            ...
            {/* ✅ Success message (simple Tailwind) */}
            {successMsg && (
                <div className="mb-4 text-green-600 font-medium text-center animate-fadeIn">
                    {successMsg}
                </div>
            )}

            {bookings.length === 0 && <p className="text-center text-gray-600">No bookings found.</p>}
                    ...
                    {b.status !== "cancelled" && (
                        <div className="flex gap-3 mt-4">
                            <Link
                                ...
                                state={{ booking: b }}
                                className="bg-blue-600 text-white px-3 py-1.5 rounded w-full text-center hover:bg-blue-700 transition"
                            >
                                Edit
                            </Link>
                            ...
                            <button
                                ...
                                className="bg-red-600 text-white px-3 py-1.5 rounded w-full hover:bg-red-700 transition"
                            >
                                Cancel
                            </button>
                        </div>
